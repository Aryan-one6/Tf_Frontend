...
//     const id1 = uuid();
//     const id2 = uuid();
//     setMessages((m) => [...m, { id: id1, from: 'user', text: trimmed, ts: Date.now() }]);
//     setInput('');
//     setTimeout(() => {
//       setMessages((m) => [
//         ...m,
...
//           id: id2,
//           from: 'bot',
//           text: "Thanks! I can help with bookings, dates, pricing — try 'search flights' or 'find hotel'.",
//           ts: Date.now(),
//         },
//       ]);
//     }, 350);
...
//               <div className="vv-chatbot__msgs" ref={msgsRef}>
//                 {messages.map((m) => (
...
//                 />
//                 <button className="vv-send-btn" onClick={sendMessage} aria-label="Send" disabled={!input.trim()}>
//                   Send
//                 </button>
//               </div>
//             </div>
