        ...
        <div className="container">
          <div className="header-nav">
            ...
            <div className="btn-box">
              <a href="tel:+91 93542 9191" className="primary-btn one gradient-bg white-color"><PhoneCall className="text-white h-4 w-4" />Call Now </a>
        ...
        <div className="sticky-header">
          <div className="container">
            <div className="header-nav">
              ...
              <div className="btn-box">
                <a href="tel:number" className="primary-btn one gradient-bg white-color"><PhoneCall className="text-white h-4 w-4" />Call Now </a>
                <a href="mailto:connect@triadflair.com" className="primary-btn one gradient-bg white-color border-btn"><Mail className="text-white h-4 w-4" />Get in touch</a>
              </div>
            </div>
          </div>
